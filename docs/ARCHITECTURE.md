...
**Note:** We use `GENERATED BY DEFAULT AS IDENTITY` instead of `SERIAL` for better SQL standard compliance. See [PostgreSQL SERIAL vs IDENTITY](https://stackoverflow.com/questions/55300370/postgresql-serial-vs-identity) for details.
